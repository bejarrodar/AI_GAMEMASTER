...
class Settings(BaseSettings):
    ...
    auth_require_sys_admin_token: bool = True
    streamlit_port: int = 9531
    streamlit_session_ttl_s: int = 28800
    ...
    db_api_token: str = ""
    db_api_require_token: bool = True
    db_api_rate_limit_window_s: int = 60
    db_api_rate_limit_max_requests: int = 600
    bot_health_port: int = 9550
    bot_admin_session_ttl_s: int = 3600
